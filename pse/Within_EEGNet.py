...
# GPU allocation
save_dir = 'C:/Users/PC/Desktop/SSSEP/result/within/EEGTCNet/'
...
for i in range(1,17):
    ...
    for fold, (train_index, test_index) in enumerate(kf.split(X)):
        ...
        model = EEGModels_torch.EEG_TCNet()
        model = model.to('cuda')
        ...
        testmodel = model
        savepath = 'C:/Users/PC/Desktop/SSSEP/result/within/EEGTCNet/testmodel.pth'
        ...
        for epoch in range(num_epochs):  # epoch
            ...
            model.load_state_dict(torch.load('C:/Users/PC/Desktop/SSSEP/result/within/EEGTCNet/testmodel.pth'))
