# -*- coding: utf-8 -*-
"""
Created on Fri Sep  3 20:18:00 2021
...
# GPU allocation
save_dir = 'C:/Users/PC/Desktop/TSA_result/EEGNet_Within/3_FBTSANet_10C2/'
result_txt = '3_FBTSANet_10C2.txt'
test_result_txt = '3_FBTSANet_10C2_test_result.txt'
##################### Process Main  ######################
for i in range(1,17):
    X = []
    Y =[]
