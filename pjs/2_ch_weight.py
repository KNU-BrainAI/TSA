...
chanenl weigth + skip connection + overlapping
...
# GPU allocation
save_dir = 'C:/Users/PC/Desktop/TSA_result/EEGNet_Within/2_ch_weight/'
result_txt = '2_ch_weight_eegnet.txt'
...
for i in range(1,17):
    ...
    for fold, (train_index, test_index) in enumerate(kf.split(X)):
        ...
        model = models.EEGNet_2_ch_weight()
        model = model.to('cuda')
