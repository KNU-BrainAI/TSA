# -*- coding: utf-8 -*-
"""
Created on Tue Sep  7 02:37:15 2021
...
# GPU allocation
save_dir = 'C:/Users/PC/Desktop/TSA_result/EEGNet_Within/10C2/'
result_txt = 'FBTSANet7.txt'
test_result_txt = 'FBTSANet7_test_result.txt'
##################### Process Main  ######################
for i in range(1,17):
    X = []
    Y =[]
