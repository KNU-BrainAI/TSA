# -*- coding: utf-8 -*-
"""
Created on Sun Sep  5 23:22:17 2021
...
# GPU allocation
save_dir = 'C:/Users/PC/Desktop/TSA_result/EEGNet_Within/3_FBTSANet_RB_10C2/'
result_txt = '3_FBTSANet_RB_10C2.txt'
test_result_txt = '3_FBTSANet_RB_10C2_test_result.txt'
##################### Process Main  ######################
for i in range(1,17):
    X = []
    Y =[]
